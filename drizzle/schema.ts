...
export const crmCanalEnum = pgEnum("crm_canal", ["whatsapp", "telefone", "email", "visita", "outro", "perdida", "nao_retornou", "esperando_cliente", "garantiu_fechamento", "aguardando_resposta"]);
