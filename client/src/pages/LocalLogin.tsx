...
export default function LocalLogin() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setError("");
    loginMutation.mutate({ emailOrName, password });
  };
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg border-0">
          <CardHeader className="pb-4">
            ...
            <CardDescription>Use seu e-mail ou nome de usuário e senha, ou entre com sua conta Manus</CardDescription>
          </CardHeader>
          <CardContent className="space-y-5">
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full gap-2 border-gray-300 bg-white hover:bg-gray-50 text-gray-700 font-medium"
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-2 text-gray-400">ou entre com usuário e senha</span>
              </div>
            </div>
