...
const page3Sections = [
  ...
  },
  {
    ...
    contentJson: JSON.stringify({
      type: "margin_table_multi",
      columns: ["Área", "1 cor", "2 cores", "3/4 cores", "Poliéster 1 cor", "Sintético Dourado"],
      rows: [
        { label: "Menor que 0,34m²", values: ["27%", "29%", "32%", "20%", "27%"] },
        { label: "Entre 0,35 e 0,60m²", values: ["27%", "29%", "32%", "20%", "27%"] },
        { label: "Entre 0,62 e 1m²", values: ["33%", "38%", "NÃO DISPONÍVEL", "18%", "33%"] },
        { label: "Entre 1,1 e 1,5m²", values: ["29%", "34%", "37%", "18%", "29%"] },
        { label: "Entre 1,51m² e 4m²", values: ["27%", "32%", "35%", "15%", "27%"] },
        { label: "Entre 4,1m² e 8m²", values: ["25%", "30%", "33%", "15%", "25%"] },
        { label: "Entre 8,1m² e 12m²", values: ["23%", "28%", "31%", "13%", "23%"] },
        { label: "Acima de 12,1m²", values: ["21%", "26%", "29%", "13%", "21%"] },
      ]
    }),
  ...
  },
  {
    ...
    contentJson: JSON.stringify({
      type: "margin_table_multi",
      columns: ["Área", "1 cor", "2 cores", "3/4 cores", "Dourado 1 cor", "Sintético Dourado"],
      rows: [
        { label: "Menor que 0,34m²", values: ["31%", "33%", "36%", "25%", "31%"] },
        { label: "Entre 0,35 e 0,60m²", values: ["31%", "33%", "36%", "25%", "31%"] },
        { label: "Entre 0,62 e 1m²", values: ["38%", "43%", "—", "23%", "38%"] },
        { label: "Entre 1,1 e 1,5m²", values: ["34%", "39%", "42%", "23%", "34%"] },
        { label: "Entre 1,51m² e 4m²", values: ["32%", "37%", "40%", "20%", "32%"] },
        { label: "Entre 4,1m² e 8m²", values: ["30%", "35%", "38%", "20%", "30%"] },
        { label: "Entre 8,1m² e 12m²", values: ["28%", "33%", "36%", "18%", "28%"] },
        { label: "Acima de 12,1m²", values: ["26%", "31%", "34%", "18%", "26%"] },
      ]
    }),
